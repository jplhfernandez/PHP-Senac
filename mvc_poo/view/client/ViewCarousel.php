<div id="banners" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="../../public/images/banner_1.jpg" alt="" class="center-block">
            </div>
            <div class="item ">
                <img src="../../public/images/banner_2.jpg" alt="" class="center-block">
            </div>
            <div class="item ">
                <img src="../../public/images/banner_3.jpg" alt="" class="center-block">
            </div>
        </div>
